...
## 現有產物
最新日出生態版位於 builds/desktop-ecology-20260913（不提交 Git）；首版 desktop-preview-20260912-r2 保留作歷史版本：
...
- 為測試遊戲流程，用相同版本 Godot 執行器載入實際產物 .pck，驗證日出補員／招募付款／不重複再生、電容安裝／充能、容量 HUD、營火投入、招募、左側城牆投入、核心失守／重開、暫停、入口與測試檔排除；同時真正渲染並保存畫面。這是打包資源驗證，不能寫成真人在成品程式完成了整局。
