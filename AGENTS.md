...
- 目前主場景從荒地步行至營火起家，騎士背包有限；現場每次投入一顆龍晶，未滿格的進度保留。夜襲逐日變強，日夜規格見 `docs/design/campfire-campaign.md`。
...
- 主戰役僅有獵人／弓兵；兵營升級強化全體弓兵，其他居民夜間在城內分散走動。規格見 `docs/design/flat-frontier.md`。
