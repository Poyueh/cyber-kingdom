...
func _run() -> void:
	var suites := ["res://tests/test_frontier_ecology.gd", "res://tests/test_knight_growth.gd", "res://tests/test_combat.gd", "res://tests/test_campaign_objective.gd", "res://tests/test_bilateral_defense.gd", "res://tests/test_resident_schedule.gd", "res://tests/test_session.gd", "res://tests/test_file_store.gd", "res://tests/test_knight_visual.gd", "res://tests/test_impact_view.gd", "res://tests/test_refuge.gd", "res://tests/test_settlement.gd", "res://tests/test_frontier.gd", "res://tests/test_frontier_workforce.gd", "res://tests/test_campaign.gd", "res://tests/test_icon_presentation.gd", "res://tests/test_crystal_flow.gd", "res://tests/test_context_investment.gd"]
