...
func _run() -> void:
	var suites := ["res://tests/test_combat.gd", "res://tests/test_session.gd", "res://tests/test_file_store.gd", "res://tests/test_knight_visual.gd", "res://tests/test_impact_view.gd"]
